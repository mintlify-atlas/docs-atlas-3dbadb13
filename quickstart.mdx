---
title: "Get Started with CFDI Stamping in ERPNext"
sidebarTitle: "Quickstart"
description: "Configure your Digital Signing Certificate and CFDI Stamping Settings, then stamp your first Sales Invoice in under 10 minutes."
---
...
<Steps>
  ...
  <Step title="Stamp a Sales Invoice">
    ...
    **If auto-stamp is not enabled:**
    ...
    3. The app sends the invoice data to the TI Sin Problemas stamping service, which returns the SAT-sealed XML. The **Stamped XML** field is updated with the result.
  ...
  <Step title="Download CFDI files">
    ...
    1. On the stamped Sales Invoice form, click **Download CFDI Files**.
    2. ERPNext will package the signed XML file and the PDF representation of the CFDI into a single ZIP archive and prompt you to download it.
