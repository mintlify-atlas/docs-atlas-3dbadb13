...
description: "Field reference for CFDI Stamping Settings — API credentials, test mode, stamp on submit, low-credit warnings, email notifications, and PDF templates."
---
