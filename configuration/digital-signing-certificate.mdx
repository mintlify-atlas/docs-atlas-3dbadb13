...
<Steps>
  ...
  <Step title="Save">
    Click **Save**. The app will validate the certificate triad (certificate,
    key, and password) using the `satcfdi` library. If the combination is
    invalid, an error is raised and the document is not saved.
  </Step>
</Steps>
